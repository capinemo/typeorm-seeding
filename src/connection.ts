...
/**
 * Path for autogenerated seed files
 */
interface SeedingCliOptions {
  seedsDir: string
}

export declare type ConnectionOptions = TypeORMConnectionOptions & SeedingOptions & { cli: SeedingCliOptions }
